        ...
        <div className="mt-6">
          ...
          <div className="text-center flex flex-wrap justify-center gap-5">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl">660 CC</span>
            </div>

            <div className="flex items-center space-x-2">
              <h1 className="font-semibold text-xl">Condition</h1>
              <span className="text-xl">9 / 10</span>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl">
                Front-MacPherson strut ; Rear-Semi-idependent
              </span>
            </div>
            <div className="flex items-center space-x-2 mb-5">
              <h1 className="font-semibold text-xl">Avg</h1>
              <span className="text-xl">20-25 Km Per Ltr</span>
            </div>
          ...
          <div className="text-center ">
            <h1 className="text-green-600 text-4xl">PKR 27,00,000</h1>
          </div>
