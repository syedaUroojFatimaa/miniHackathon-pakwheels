  ...
  return (
    <div>
          ...
          <h1 className="text-center text-4xl font-semibold underline">
            Toyota Civic 2024 Price in Pakistan,Images,Reviews & Specs
          </h1>
          <Image
          src="/Images/car04.jpeg"
            alt="car.pic"
            height={400}
            width={400}
          ...
          <div className="mt-6">
            ...
            <div className="text-center flex flex-wrap justify-center gap-5">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl">2000 CC</span>
              </div>

              <div className="flex items-center space-x-2">
                <h1 className="font-semibold text-xl">Condition</h1>
                <span className="text-xl">10 / 10</span>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl">18 Km Per ltr</span>
              </div>
            ...
            <div className="text-center ">
              <h1 className="text-green-600 text-4xl">PKR 85,00,000</h1>
            </div>
