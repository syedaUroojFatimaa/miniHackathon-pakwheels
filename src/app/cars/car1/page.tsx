          ...
          <div className="mt-6">
            ...
            <div className="text-center flex flex-wrap justify-center gap-5">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl">1800 CC</span>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl">Soft Suspension</span>
              </div>
              <div className="flex items-center space-x-2">
                <h1 className="font-semibold text-xl">Avg</h1>
                <span className="text-xl">13 Km Per ltr</span>
              </div>

              <div className="flex items-center space-x-2 mb-5">
                <h1 className="font-semibold text-xl">Transmission</h1>
                <span className="text-xl">Automatic</span>
              </div>
              <div className="flex items-center space-x-2 mb-5">
                <h1 className="font-semibold text-xl">Fuel Type</h1>
                <span className="text-xl">High Octane</span>
              </div>
            </div>
            <div className="text-center ">
              <h1 className="text-green-600 text-4xl">PKR 50,00,000</h1>
            </div>
